public class App {
    /**
     * 6. Escribir una función que dadas dos matrices devuelve la matriz donde la
     * primera columna es la
     * suma, la segunda columna el producto y la tercera columna la media de las
     * correspondientes
