...
public class Actividad7 {
    ...
    //Ahora, haciendo uso de memoria dinámica: 
    //a) Añade un nuevo alumno y sus calificaciones. b) Elimina la columna de Programación y sus notas.
    public static void  añadiralumno(String[] alumnos, String[] materias, double[][] notas){
        // Pedimos el nombre del alumno
        Scanner teclado=new Scanner(System.in);
        String[] nuevosAlumnos = new String[alumnos.length + 1];
        double[][] notas2=new double[alumnos.length+1][materias.length];
