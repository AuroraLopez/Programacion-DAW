...
public class AplicJSON {
    public static void main(String[] args) {
        try {
        // Lectura del contenido del fichero JSON
        Object ob = new JSONParser().parse(new FileReader("C:\\Users\\\\Auri\\Desktop\\1º DAW\\Programación\\Programacion-DAW\\Unidad5\\src\\Lecciones\\prueba.json"));
        // Convertir objeto a JSON y procesarlo
        JSONObject js = (JSONObject) ob;
        // Convirtiendo cada componente en json
